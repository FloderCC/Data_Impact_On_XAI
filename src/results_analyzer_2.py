...
def load_dataframe_with_the_correlations_and_plot():  # SRCC
    ...
    for performance, data in data_to_plot.items():
        ...
        # setting font size
        plt.rcParams.update({'font.size': 18})
        ax = sns.barplot(x='XAI pair', y=f'XAI SRCC', data=df_to_plot, errorbar='sd', hue='Dataset', legend=True, palette='tab20')
...
def load_dataframe_with_the_correlations_and_plot_data_impact():
    ...
    for input_feature in input_features:
        ...
        plt.savefig(f'plots/3_correlations_final.png', bbox_inches='tight')
